...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen relative bg-transparent flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        {/* Logo */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-green-500 rounded-full mb-4 shadow-lg glow-green">
            <Leaf className="w-12 h-12 text-white leaf-energy" />
          </div>
          <h1 className="text-3xl font-bold text-white mb-2">Sinh Học Vui</h1>
          <p className="text-green-200">Tạo tài khoản mới</p>
        </div>
        ...
        <div className="game-card">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              <label className="block text-green-200 text-sm mb-2">Tên người dùng</label>
            ...
            <div>
              <label className="block text-green-200 text-sm mb-2">Mật khẩu</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="game-input !pl-11 pr-12"
                  required
                  minLength={6}
                />
                <button
                ...
                >
                  {showPassword ? (
                    <EyeOff className="w-5 h-5 text-green-400 hover:text-green-300" />
                  ) : (
            ...
            <div>
              <label className="block text-green-200 text-sm mb-2">Xác nhận mật khẩu</label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-green-400" />
                <input
                  type={showPassword ? 'text' : 'password'}
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-transparent text-green-200">hoặc</span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-800 font-semibold py-3 px-6 rounded-xl transition-all duration-300 disabled:opacity-50"
          >
