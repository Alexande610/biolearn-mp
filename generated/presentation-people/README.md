...
Hồ sơ mẫu ở `presentation_people` **không phải** tài khoản Auth. Họ không thể đăng nhập, ghép trận, nhận thưởng, nhận thư hoặc thay đổi tiến độ của người dùng thật. Các bảng xếp hạng và báo cáo admin ghép dữ liệu mẫu ở lớp hiển thị, có nhãn `Mẫu` hoặc thông báo số lượng hồ sơ mẫu.
...
6. Kiểm tra bằng một học viên và một admin: bảng tổng, bảng tuần, PvP lớp 6–12; số học viên/giáo viên, điểm trung bình, số bài hoàn thành, DAU và biểu đồ admin. Xác nhận hàng mẫu có nhãn, người thật vẫn hiển thị và không có hồ sơ mẫu trong hàng chờ PvP.
