...
const stages = [
  {
    ...
    source: book('17-19', 'Bài 5. Sử dụng kính hiển vi quang học'),
  ...
  },
  {
    ...
    source: book('75-78', 'Bài 18. Tế bào - Đơn vị cơ bản của sự sống'),
    ...
    match: [['Tế bào thần kinh', 'Có phần kéo dài để truyền tín hiệu'], ['Tế bào hồng cầu', 'Có dạng đĩa lõm hai mặt'], ['Tế bào trứng', 'Có dạng gần hình cầu']],
    fill: ['Các tế bào khác nhau có hình dạng và kích thước [blank].', 'khác nhau'],
    category: [['Có thể quan sát bằng mắt thường', 'Cần dụng cụ phóng đại'], [['Tế bào trứng cá', 0], ['Tế bào vi khuẩn', 1], ['Tế bào biểu bì hành', 1], ['Tế bào sợi gai', 0]]],
  ...
  },
  {
    ...
    source: book('79-81', 'Bài 19. Cấu tạo và chức năng các thành phần của tế bào'),
  ...
  },
  {
    ...
    source: book('80-82', 'Bài 19. Cấu tạo và chức năng các thành phần của tế bào'),
  ...
  },
  {
    ...
    source: book('81-82', 'Bài 19. Cấu tạo và chức năng các thành phần của tế bào'),
    ...
    category: [['Đặc trưng ở tế bào thực vật', 'Có ở cả tế bào thực vật và động vật'], [['Lục lạp', 0], ['Thành tế bào', 0], ['Màng tế bào', 1], ['Tế bào chất', 1], ['Nhân', 1]]],
  ...
  },
  {
    ...
    source: book('83-84', 'Bài 20. Sự lớn lên và sinh sản của tế bào'),
  ...
  },
  {
    ...
    source: book('84-85', 'Bài 20. Sự lớn lên và sinh sản của tế bào'),
  ...
  },
  {
    ...
    source: book('86-87', 'Bài 21. Thực hành: Quan sát và phân biệt một số loại tế bào'),
  ...
  },
  {
    ...
    source: book('76-82', 'Bài 18-19. Tế bào và cấu tạo tế bào'),
  ...
  },
  {
    ...
    source: book('75-88', 'Bài 18-21. Tế bào'),
    ...
    category: [['Đúng với tế bào thực vật', 'Đúng với tế bào vi khuẩn'], [['Có thành tế bào', 0], ['Có thể có lục lạp', 0], ['Thuộc kiểu tế bào nhân sơ', 1], ['Chưa có nhân hoàn chỉnh', 1]]],
...
fs.writeFileSync('content/stations/grade-06/station-01.json', `${JSON.stringify(document, null, 2)}\n`);
